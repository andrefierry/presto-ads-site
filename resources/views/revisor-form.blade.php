                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6 p-4 border-end border-danger">
                            <form method='POST' action="{{route('become.revisor')}}">
                                ...
                                <div class="mb-4">
                                    <label for="name" class="form-label text-dark fs-6 fw-bold mt-3">Inserisci il tuo nome:</label>
                                    <input name="name" type="text" class="form-control w-100" id="name">
                                </div>
                                <div class="mb-4">
                                    <label for="email" class="form-label text-dark fs-6 fw-bold">Inserisci la tua e-mail:</label>
                                    <input name="email" type="text" class="form-control w-100" id="email">
                                </div>
                                 <label class="form-label text-dark fs-6 fw-bold">Perché vuoi diventare revisore?</label>
                                ...
                                <div class="d-flex justify-content-center">
                                    <button type="submit" class="btn btn-outline-danger shadow px-5 mt-3 text fw-bold" role="button">Diventa Revisore</button>
                                </div>
                            </form>
                        </div>
                        <div class="d-sm-none col-md-4 col-lg-6 d-lg-flex align-items-center justify-content-center border border-left-2 flex-column">
                            ...
                            <p class="text-primary fs-6 fw-bold text-center">Inviaci la tua e-mail</p>
                            <p class="text-primary fs-5 fw-bold text-center ">per diventare revisore</p>
                        </div>
                    </div>
                </div>
            </div>
