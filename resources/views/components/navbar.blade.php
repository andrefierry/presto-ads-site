...
<nav class="navbar navbar-expand-lg bg-body-tertiary shadow">
  <div class="container-fluid">
      ...
      <ul class="navbar-nav my-2 my-lg-0 navbar-nav-scroll ms-auto d-flex align-items-center bg-toggle" style="--bs-scroll-height: 270px;">
        {{-- <div class="dropdown mx-3"> --}}
          ...
          <ul class="d-flex list">
            <li class="">
              <x-_locale lang='it' nation='it'/><h6 class="mb-0"></h6>
            </li>
            <li class="">
              <x-_locale lang='en' nation='gb'/><h6 class="mb-0"></h6>
            </li>
            <li class="">
              <x-_locale lang='es' nation='es'/><h6 class="mb-0"></h6>
            </li>
          </ul>
          {{-- </div> --}}
        ...
        @auth
        <div class="dropdown">
          <button class="dropdown-toggle dropdown-item" type="button" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    @endauth
    <form action="{{route('articles.search')}}" method="GET"  role="search">
      <div class="contain">
