          ...
          <div class="col-9 p-5 shadow form-custom rounded">
            <div class="col-6 form p-5 rounded border border-2 shadow border border-dark">
              <h2 class="fw-bold display-5 text-center">Registrati</h2>
                <p class="text text-center mt-3 mb-4 fs-6">Entra nella tua area riservata</p>
              <form method="POST" action="{{route('register')}}">
                @csrf
                <div class="mb-3">
                  <label for="name" class="form-label text fs-6">Nome utente</label>
              ...
              <div class="mb-3">
                  <label for="password_confirmation" class="form-label text fs-6">Conferma password</label>
